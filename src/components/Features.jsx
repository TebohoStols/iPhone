...
const Features = () => {
    ...
    useGSAP( () => {
        ...
        {/**Animate the text below the images */}
  ...
  return (
    <section className='h-full common-padding bg-zinc relative overflow-hiddden'>
        <div className='screen-max-width'>
            <div className='mb-12 2-full'>
